...
public class MainApp {
    ...
    public static final String BOOKS_PATH = "src/Books.txt";
    public static final String RATINGS_PATH = "src/Ratings.txt";
    ...
    public static void initElements() throws IOException {
        ...
        users = Files.lines(Paths.get(USERS_PATH))
                .map(lines -> new User(lines))
                .collect(Collectors.toMap(User::getId, user -> user));

        books = Files.lines(Paths.get(BOOKS_PATH))
                .map(lines -> new Book(lines))
